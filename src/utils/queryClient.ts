...
queryClient.setQueryDefaults(["kyc", "status"], { staleTime: 5 * 60_000, gcTime: 60 * 60_000, retry: 2 });
queryClient.setQueryDefaults(["legacy", "kyc", "status"], { staleTime: 5 * 60_000, gcTime: 60 * 60_000, retry: 2 });
