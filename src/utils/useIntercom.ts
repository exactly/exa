        ...
        return {
          ...
          presentCollection: async (collectionId: string) => {
            if (await sdk.isInMiniApp()) {
              await sdk.actions.openUrl(`https://intercom.help/exa-app/en/collections/${collectionId}`);
            } else {
              await openBrowserAsync(`https://intercom.help/exa-app/en/collections/${collectionId}`);
              return true;
            }
            return true;
          },
