...
import chain, { allowlists, exaAddress, mockSwapperAbi, stocks, swapperAddress } from "@exactly/common/generated/chain";
...
const base58check = createBase58check((bytes: Uint8Array) => sha256(bytes, "bytes"));
