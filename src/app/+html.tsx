  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta
          name="fc:miniapp"
          content={`{"version":"1","imageUrl":"https://exactly.app/og-image.webp","button":{"title":"Get your card","action":{"type":"launch_miniapp","name":"${appMetadata.title}","url":"https://${domain}"}}}`}
        />
