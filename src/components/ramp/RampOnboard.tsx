                  ...
                  <Text color="$uiNeutralPlaceholder" footnote textAlign="center">
                    {offramp
                      ? isCrypto
                        ...
                        : method
                          ? t(
                              "Transfer USDC to a bank account via {{method}}. Add the recipient's bank details to start.",
                              { method },
                            )
                          : t("Transfer USDC to a bank account. Add the recipient's bank details to start.")
                      : isCrypto
