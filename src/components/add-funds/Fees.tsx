...
function rows(
  ...
  return [
    ...
    ...(currency === "USD"
      ? [
          { label: "ACH fee", value: rampFees.bridge.ACH.fee, caption: undefined },
          { label: "WIRE fee", value: rampFees.bridge.WIRE.fee, caption: undefined },
        ]
      : [{ label: `${method} fee`, value: fee.fee, caption: undefined }]),
  ];
}
