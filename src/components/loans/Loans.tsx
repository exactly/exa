        ...
        >
          <>
                  ...
                  <Pressable
                    onPress={() => {
                      if (appNavigator.canGoBack()) {
                        ...
                        appNavigator.replace("(home)", { screen: "defi" });
                      }
                    }}
                  >
            ...
            <View gap="$s6" padded>
              ...
              <UpcomingPayments
                onSelect={(maturity) => {
                  appNavigator.setParams({ ...parameters, maturity: maturity.toString() });
            ...
            <PaymentSheet
              ...
              onClose={() => {
                ...
                appNavigator.replace("(home)", { screen: "loans", params: { ...parameters, maturity: null } });
              }}
            />
          </>
        </ScrollView>
