        ...
        >
          <Pressable
            onPress={() => {
              ...
              appNavigator.replace("loan", { screen: "receiver" });
            }}
          >
        ...
        <YStack flex={2} justifyContent="flex-end" gap="$s5">
          {success && (
            <Button
              primary
              onPress={() => {
                appNavigator.replace("pending-proposals/index");
              }}
            >
          ...
          <Text
            ...
            onPress={() => {
              if (error && appNavigator.canGoBack()) {
                appNavigator.goBack();
                return;
              }
              appNavigator.replace("(home)", { screen: "loans" });
            }}
          >
            {error ? "Go back" : "Close"}
          </Text>
