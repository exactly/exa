    ...
    <SafeView fullScreen>
      ...
      >
        <YStack padding="$s4" gap="$s4" flex={1} justifyContent="space-between">
          <YStack paddingHorizontal="$s4" gap="$s6">
            <YStack gap="$s4_5">
              ...
              <YStack gap="$s3">
                ...
                >
                  ...
                  >
                    {receiverType === "internal" && <Check size={12} color="$uiNeutralPrimary" />}
                  </XStack>
                  <YStack gap={2}>
                ...
                >
                  <XStack
                    ...
                    justifyContent="center"
                  >
                    {receiverType === "external" && <Check size={12} color="$uiNeutralPrimary" />}
                  </XStack>
                  <YStack gap={2}>
                      ...
                      return (
                        <YStack gap="$s4">
                          ...
                          <Text caption2 color="$uiNeutralPlaceholder">
                            ...
                            <Text caption2 emphasized color="$uiBrandSecondary">
