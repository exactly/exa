...
describe("ramp api", () => {
  ...
  describe("get", () => {
    ...
    it("passes the business account type without a bridge customer", async () => {
      ...
      vi.spyOn(manteca, "getProvider").mockResolvedValue({ onramp: { currencies: [] }, status: "NOT_AVAILABLE" });
  ...
  describe("onboarding", () => {
    ...
    describe("bridge", () => {
      ...
      it("rejects onboarding for a business credential", async () => {
        await setBridgeCredential({ salt: businessSalt });
...
const businessSalt = padHex("0x123", { size: 20 });
