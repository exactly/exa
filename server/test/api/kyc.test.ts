...
describe("authenticated", () => {
  ...
  describe("cardLimit scope", () => {
    ...
    describe("getting kyc", () => {
      ...
      it("returns pending when inquiry is completed", async () => {
        vi.spyOn(persona, "getInquiry").mockResolvedValueOnce({
          ...personaTemplate,
          attributes: { ...personaTemplate.attributes, status: "completed" },
        });
      ...
      it("returns pending when inquiry is needs_review", async () => {
        vi.spyOn(persona, "getInquiry").mockResolvedValueOnce({
          ...personaTemplate,
          attributes: { ...personaTemplate.attributes, status: "needs_review" },
        });
      ...
      it("returns failed when inquiry is failed", async () => {
        vi.spyOn(persona, "getInquiry").mockResolvedValueOnce({
          ...personaTemplate,
          attributes: { ...personaTemplate.attributes, status: "failed" },
        });
      ...
      it("returns failed when inquiry is declined", async () => {
        vi.spyOn(persona, "getInquiry").mockResolvedValueOnce({
          ...personaTemplate,
          attributes: { ...personaTemplate.attributes, status: "declined" },
        });
    ...
    describe("posting kyc", () => {
      ...
      it("resumes a pending inquiry", async () => {
        const sessionToken = "persona-session-token";
      ...
      it("resumes an expired inquiry", async () => {
        const sessionToken = "persona-session-token";
      ...
      it("resumes a created inquiry", async () => {
        const sessionToken = "persona-session-token";
      ...
      it("returns failed for declined inquiry", async () => {
        vi.spyOn(persona, "getInquiry").mockResolvedValueOnce({
          ...personaTemplate,
          attributes: { ...personaTemplate.attributes, status: "declined" },
        });
      ...
      it("returns failed for failed inquiry", async () => {
        vi.spyOn(persona, "getInquiry").mockResolvedValueOnce({
          ...personaTemplate,
          attributes: { ...personaTemplate.attributes, status: "failed" },
        });
