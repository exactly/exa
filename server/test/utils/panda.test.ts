...
describe("business application", () => {
  ...
  it("maps the ultimate beneficial owners", () => {
    const application = panda.businessApplication(
      "reference-id",
      account,
      "127.0.0.1",
      profile({
        ...
        ubo_name_1: "John",
        ubo_last_name_1: "Roe",
        ubo_birth_date: "1980-02-02",
        ubo_country_id_1: "US",
        ubo_email_1: "john@example.com",
        ubo_id_1: "987654321",
        street_1_3: "2 Second St",
        street_2_2: "Suite 3",
        city_3: "Boston",
        subdivision_3: "MA",
        postal_code_3: "02108",
        ...
        ubo_name_3: "Jill",
        ubo_last_name_3: "Poe",
        ubo_birth_date_3: "1985-03-03",
        ubo_country_id_3: "CA",
        ubo_email_3: "jill@example.com",
        ubo_id_3: "111222333",
        street_1_5: "3 Third St",
        street_2_4: "Suite 4",
        city_5: "Toronto",
        subdivision_5: "ON",
        postal_code_5: "M5H 2N2",
        country_code_5: "CA",
        ubo_name_4: "June",
        ubo_last_name_4: "Doe",
        ubo_birth_date_4: "1990-04-04",
        ubo_country_id_4: "US",
        ubo_email_4: "june@example.com",
        ubo_id_4: "222333444",
        street_1_6: "4 Fourth St",
        street_2_5: "Suite 5",
        city_6: "Chicago",
        subdivision_6: "IL",
        postal_code_6: "60601",
    ...
    expect(application.ultimateBeneficialOwners).toStrictEqual([
      {
        address: {
          line1: "2 Second St",
          line2: "Suite 3",
  ...
  it("skips blank ultimate beneficial owners", () => {
    const application = panda.businessApplication(
      "reference-id",
      account,
      "127.0.0.1",
      profile({ ...businessFields, ubo_birth_date: "", ubo_name_1: "  " }),
    );

    expect(application.ultimateBeneficialOwners).toStrictEqual([]);
  });

  it("rejects a partially filled ultimate beneficial owner", () => {
    expect(() =>
      panda.businessApplication(
        "reference-id",
        account,
        "127.0.0.1",
        profile({ ...businessFields, ubo_name_1: "John" }),
      ),
    ).toThrow(
  ...
  it("rejects an ultimate beneficial owner with the wrong type", () => {
    expect(() =>
      panda.businessApplication("reference-id", account, "127.0.0.1", profile({ ...businessFields, ubo_name_1: 123 })),
    ).toThrow(
      expect.objectContaining({
  ...
  it.each([["business_name"], ["company_description"]] as const)("rejects a missing %s", (name) => {
    expect(() =>
      panda.businessApplication(
        "reference-id",
        account,
  ...
  it("rejects a business account field with the wrong type", () => {
    expect(() =>
      panda.businessApplication(
        ...
        account,
        "127.0.0.1",
        profile({ ...businessFields, business_name: 123 }),
      ),
    ).toThrow(
      expect.objectContaining({
        message: "invalid business Persona fields",
