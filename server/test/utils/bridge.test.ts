...
const client = createBridge("bridge", "https://bridge.test");
const bridge = {
  ...Bridge,
  ...client,
  getProvider: (params: Parameters<typeof client.getProvider>[0]) => client.getProvider(params, persona),
  onboarding: (params: Parameters<typeof client.onboarding>[0]) => client.onboarding(params, database, persona),
};
