...
describe("bridge utils", () => {
  ...
  describe("getCustomer", () => {
    ...
    it("throws on other errors", async () => {
      ...
      await expect(bridge.getCustomer("cust-123")).rejects.toThrow("500 internal error");
    });
  });
  ...
  describe("createCustomer", () => {
    ...
    it("throws INVALID_ADDRESS when residential_address is invalid", async () => {
      ...
      expect(captureException).toHaveBeenCalledWith(
        expect.objectContaining({ message: "invalid address" }),
    ...
    it("throws on other errors", async () => {
      ...
      await expect(bridge.createCustomer(mockCreateCustomerPayload)).rejects.toThrow("400 bad request");
    });
  });
  ...
  describe("getProvider", () => {
    ...
    describe("without existing customer", () => {
      ...
      it("appends spei endorsement for MX country", async () => {
        ...
        await bridge.getProvider({ credentialId: "cred-1" });
  ...
  describe("getDepositDetails", () => {
    ...
    it("throws NOT_AVAILABLE_CURRENCY when currency is not endorsed", async () => {
      vi.spyOn(globalThis, "fetch").mockResolvedValueOnce(mockFetchResponse({ count: 0, data: [] }));
...
function mockEndorsement(name: "base" | "pix" | "sepa" | "spei", status: "approved" | "incomplete" | "revoked") {
