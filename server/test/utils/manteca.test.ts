...
const client = createManteca("manteca", "https://manteca.test");
const manteca = {
  ...Manteca,
  ...client,
  onboarding: (account: Parameters<typeof client.onboarding>[0], credentialId: string) =>
    client.onboarding(account, credentialId, persona),
};
