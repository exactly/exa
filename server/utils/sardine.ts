...
const baseURL =
  {
    "web.exactly.app": "https://api.sardine.ai",
  }[domain] ?? "https://api.sandbox.sardine.ai";
...
const CustomerRequest = object({
  ...
  customer: optional(
    object({
      ...
      createdAtMillis: optional(number()), //cspell:ignore createdAtMillis
  ...
  device: optional(object({ ip: string(), createdAtMillis: number() })),
