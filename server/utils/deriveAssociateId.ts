 ...
 * The ID is generated by hashing the account address and the auth secret, then converting to base36.
 *
...
export default function deriveAssociateId(account: string): string {
  const hash = keccak256(encodePacked(["address", "string"], [account as `0x${string}`, authSecret]));
