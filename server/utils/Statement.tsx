        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerRight}>
            ...
            <Text style={styles.headerDetail}>
              ...
              {format(new Date((maturity - MATURITY_INTERVAL) * 1000))}
            </Text>
          </View>
        </View>
        <View style={styles.infoBar}>
          <View style={styles.infoCell}>
            ...
            <Text style={styles.infoValue}>
              {format(new Date((maturity - MATURITY_INTERVAL) * 1000))} to {format(new Date(maturity * 1000))}
            </Text>
          </View>
          <View style={styles.infoCellBorder}>
            <Text style={styles.infoLabel}>Due date</Text>
            <Text style={styles.infoValue}>{format(new Date(maturity * 1000))}</Text>
          </View>
          <View style={styles.infoCellBorder}>
            ...
            <View key={card.id} style={styles.section}>
              ...
              {card.purchases.map((purchase) => (
                <View key={purchase.id} style={styles.tableRow}>
                  <Text style={styles.colDate}>{format(new Date(purchase.timestamp))}</Text>
            ...
            {payments.map((payment) => {
              ...
              return (
                <View key={payment.id} style={styles.tableRow}>
                  <Text style={styles.colDate}>{format(new Date(payment.timestamp))}</Text>
