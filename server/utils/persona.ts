...
export const Account = object({
  ...
  attributes: object({
    "country-code": nullish(string()),
    "social-security-number": nullish(string()),
    "address-street-1": nullish(string()),
    "address-street-2": nullish(string()),
    "address-city": nullish(string()),
    "address-subdivision": nullish(string()),
    "address-postal-code": nullish(string()),
