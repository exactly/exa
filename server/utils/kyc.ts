...
// TODO review
if (!process.env.KYC_API_URL) throw new Error("missing kyc api url");
const baseURL = process.env.KYC_API_URL;

if (!process.env.KYC_API_KEY) throw new Error("missing kyc api key");
