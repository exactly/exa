---
title: Resources
description: Key resources to set up an integration, including Exa server IPs for allow listing and Rain RSA public keys.
sidebar:
  label: Resources
  order: 10
---

Key resources to set up an integration
...
```text
-----BEGIN PUBLIC KEY-----

EQIDAQAB
-----END PUBLIC KEY-----
```
