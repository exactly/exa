...
/** @param {import("@sentry/react-native/dist/js/tools/vendor/metro/metroBabelTransformer").BabelTransformerArgs} args */
module.exports.transform = function transform(args) {
  if (args.filename.endsWith(".svg")) {
    if (args.src.includes(' data-themed=""')) {
  ...
  return require("@sentry/react-native/dist/js/tools/sentryBabelTransformer").transform(args);
};
