...
fn main() -> Result<(), Error> {
  ...
  println!("cargo::rerun-if-changed=../contracts/node_modules/@exactly/protocol/contracts/Auditor.sol");

  create_dir_all("abi")?;
  let contracts = [("auditor", "Auditor"), ("factory", "ExaAccountFactory"), ("lifi", "MockSwapper")];
